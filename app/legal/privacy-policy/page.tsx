...
const PrivacyPolicy = () => {
  return (
    <div className="mx-auto max-w-3xl bg-white p-6 text-gray-800">
      ...
      <section className="mb-6">
        <h2 className="mb-2 text-xl font-semibold text-blue-700">1. Information We Collect</h2>
        <p className="mt-4">
      ...
      <section className="mb-6">
        <h2 className="mb-2 text-xl font-semibold text-blue-700">2. Use of Your Information</h2>
      ...
      <section className="mb-6">
        ...
        <p className="mt-4">We do not sell, rent, or lease your personal information to third parties.</p>
        <p className="mt-4">
      ...
      <section className="mb-6">
        <h2 className="mb-2 text-xl font-semibold text-blue-700">4. Your Rights and Choices</h2>
        <p className="mt-4">You have the following choices regarding the collection and use of your information:</p>
        <ul className="ml-4 list-inside list-disc">
          <li>
      ...
      <section className="mb-6">
        <h2 className="mb-2 text-xl font-semibold text-blue-700">6. Children’s Privacy</h2>
        <p className="mt-4">
      ...
      <section className="mb-6">
        <h2 className="mb-2 text-xl font-semibold text-blue-700">8. Contact Us</h2>
        <p className="mt-4">
