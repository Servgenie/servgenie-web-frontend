...
import { EFFECTIVE_DATE } from '../common/constants';
...
const TermsOfService = () => {
  return (
    <section className="mx-auto max-w-3xl bg-white p-6 text-gray-800">
      ...
      <section className="mb-6">
        <h2 className="mb-2 text-xl font-semibold text-blue-700">1. Use of the Service</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="mb-2 text-xl font-semibold text-blue-700">2. User Information</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="mb-2 text-xl font-semibold text-blue-700">3. Electronic Communications</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="mb-2 text-xl font-semibold text-blue-700">4. Prohibited Activities</h2>
      ...
      <section className="mb-6">
        <h2 className="mb-2 text-xl font-semibold text-blue-700">5. Intellectual Property</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="mb-2 text-xl font-semibold text-blue-700">6. Limitation of Liability</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="mb-2 text-xl font-semibold text-blue-700">7. Termination</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="mb-2 text-xl font-semibold text-blue-700">8. Governing Law</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="mb-2 text-xl font-semibold text-blue-700">10. Changes to Terms</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="mb-2 text-xl font-semibold text-blue-700">11. Contact Us</h2>
      ...
      <section className="mb-6">
        <h2 className="mb-2 text-xl font-semibold text-blue-700">Privacy</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="mb-2 text-xl font-semibold text-blue-700">Children Under Thirteen</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="mb-2 text-xl font-semibold text-blue-700">Links to Third-Party Sites</h2>
        <p>
