    ...
    <div className="mx-auto max-w-3xl bg-white p-6 text-gray-800">
      ...
      <section className="mb-6">
        ...
        <ul className="ml-4 list-inside list-disc">
          ...
          <li>
            <strong>Other Information:</strong> We may also collect data about how you interact with
            our website and services, including trends and usage patterns, to improve the user
            experience.
          </li>
        </ul>
        <p className="mt-4">
