  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          type="submit"
          className={`ps-slim group pl-2 mr-1 bg-[#111928] flex h-[40px] w-[97px] cursor-pointer items-center justify-center gap-1 rounded-full text-sm text-white`}
        >
          {loading ? (
      ...
      >
        <p className="ps-slim w-[483px] text-center text-sm sm:text-[1rem]">
